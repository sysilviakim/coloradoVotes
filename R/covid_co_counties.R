...
link <- paste0("https://raw.githubusercontent.com/nytimes/",
...
link2 <- paste0("https://www2.census.gov/programs-surveys/popest/datasets/",
...
assert_that(length(setdiff(unique(co_population$ctyname), "Colorado")) == 64)
